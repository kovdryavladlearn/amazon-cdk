...
var ddClient = (0, import_aws_xray_sdk_core.captureAWSv3Client)(new import_client_dynamodb5.DynamoDBClient({}));
async function handler(event, context) {
  let response;
  const subSeg = (0, import_aws_xray_sdk_core.getSegment)().addNewSubsegment("MyLongCall");
  await new Promise((resolve) => {
    setTimeout(resolve, 3e3);
  });
  subSeg.close();
  const subSeg2 = (0, import_aws_xray_sdk_core.getSegment)().addNewSubsegment("MyLongCall");
  await new Promise((resolve) => {
